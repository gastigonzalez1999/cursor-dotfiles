...
description: Thermo-nuclear code quality audit (maintainability, structure, 1k-line rule, spaghetti, code-judo). Invoked via Task after a parent gathers diff and file contents. Loads its rubric from the thermo-nuclear-code-quality-review skill.
---
...
1. Load the `thermo-nuclear-code-quality-review` skill — it ships from this toolkit alongside this agent — and treat its `SKILL.md` as the **complete** rubric: tone, approval bar, output ordering, code-judo / 1k-line / spaghetti rules.
